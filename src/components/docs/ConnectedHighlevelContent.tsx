          ...
          <div className="flex items-start gap-3">
            ...
            <div>
              ...
              <p className="text-[13.5px] leading-relaxed text-slate-750 dark:text-blue-200">
                If your Location ID displays as <code className="text-[12px] bg-slate-150 dark:bg-slate-800 px-1.5 py-0.5 rounded font-mono text-slate-800 dark:text-slate-200">null</code>, or contacts fail to sync, verify your Custom Menu Link settings under GoHighLevel Settings. Ensure that <em>Pass contact/user info as query parameters</em> is checked so NOLA can map sub-account identifiers dynamically.
              </p>
            </div>
          </div>
        </div>
