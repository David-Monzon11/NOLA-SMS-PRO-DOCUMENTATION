      ...
      <section id="install-prerequisites" className="space-y-4">
        ...
        <div className="grid gap-3 sm:grid-cols-2">
          {[
            ...
            <div key={item.label} className="flex items-start gap-3 rounded-xl border border-slate-200 bg-white p-4 dark:border-slate-850 dark:bg-slate-900/30">
        ...
        <div className="space-y-4">
          {steps.map((step, idx) => (
            <React.Fragment key={idx}>
              ...
              {idx === 1 && (
                <div className="flex items-start gap-3.5 rounded-xl border border-amber-250 bg-amber-50/40 px-5 py-4 dark:border-amber-900/40 dark:bg-amber-955/10 my-1">
                  <AlertTriangle className="mt-0.5 h-4 w-4 flex-shrink-0 text-amber-600 dark:text-amber-400" />
                  <p className="text-[13px] leading-relaxed text-amber-800 dark:text-amber-305 font-semibold">
              ...
              <div className="flex items-start gap-4 rounded-2xl border border-slate-200 bg-white p-5 dark:border-slate-800/80 dark:bg-[#111827] shadow-sm transition-all duration-200 hover:-translate-y-0.5 hover:border-slate-400 dark:hover:border-slate-600 hover:shadow-md group">
                ...
                {/* Icon */}
                <div className="flex-shrink-0 text-slate-400 dark:text-slate-600 mt-0.5 group-hover:text-blue-500 dark:group-hover:text-blue-450 transition-colors">
                  {step.icon}
                </div>
              </div>
            </React.Fragment>
