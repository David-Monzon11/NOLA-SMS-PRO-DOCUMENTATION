...
const ContactFormatMockup: React.FC = () => (
  <div className="flex h-full flex-col p-4 sm:p-5 justify-center gap-4">
    <h4 className="text-[13px] font-black text-[#0B2E63] dark:text-white uppercase tracking-wider">Philippine Number Formatting Check</h4>
...
const ContactsListMockup: React.FC = () => (
  <div className="flex h-full flex-col p-4 sm:p-5">
    <div className="flex justify-between items-center mb-3">
      <span className="text-[10px] font-black text-blue-500 uppercase tracking-wider">CRM Sync Contacts Database</span>
      <div className="h-5 w-32 rounded bg-[#E8F3FF] dark:bg-[#102B4F] text-[9px] text-[#1F5AAE] dark:text-[#72A8FF] flex items-center justify-center font-bold">Search contacts...</div>
    </div>
    <div className="overflow-x-auto">
      <table className="w-full text-left text-[11px]">
        ...
        <tbody className="divide-y divide-slate-100/50 dark:divide-slate-800/50 text-[#425B7D] dark:text-slate-300">
          <tr>
...
const TemplateInterpolationMockup: React.FC = () => (
  <div className="grid h-full gap-4 p-4 sm:p-5 sm:grid-cols-2 justify-center items-center">
    <div className="rounded-xl border border-blue-200 bg-white p-3.5 dark:border-blue-900/30 dark:bg-slate-900">
      <span className="text-[10px] font-black text-blue-500 uppercase tracking-wider block mb-2">Draft Template Input</span>
      <div className="rounded border border-[#D7E7FA] p-2.5 font-mono text-[11.5px] text-[#425B7D] dark:border-[#1F3D68] dark:bg-[#07111F] min-h-[72px]">
        Hello <span className="text-[#1F5AAE] dark:text-[#72A8FF] font-bold">{"{{contact.first_name}}"}</span>, your appointment is set for <span className="text-[#1F5AAE] dark:text-[#72A8FF] font-bold">{"{{appointment.time}}"}</span>.
      </div>
    </div>
    <div className="flex flex-col items-center justify-center">
      <div className="w-8 h-8 rounded-full bg-[#E8F3FF] dark:bg-[#102B4F] flex items-center justify-center text-[#1F5AAE] dark:text-[#72A8FF] mb-2 font-black">
      ...
      <div className="rounded-xl border border-emerald-200 bg-white p-3.5 dark:border-emerald-900/30 dark:bg-slate-900 w-full">
        ...
        <div className="rounded border border-[#D7E7FA] p-2.5 font-mono text-[11.5px] text-slate-800 dark:border-[#1F3D68] dark:bg-[#07111F] min-h-[72px] bg-slate-50/50">
...
const TemplatesListMockup: React.FC = () => (
  <div className="flex h-full flex-col p-4 sm:p-5">
    <div className="flex justify-between items-center mb-3">
      <span className="text-[10px] font-black text-blue-500 uppercase tracking-wider">Saved Message Templates</span>
      <div className="h-5 w-24 rounded bg-blue-500 text-white text-[9px] flex items-center justify-center font-bold cursor-pointer">+ New Template</div>
    </div>
    <div className="grid gap-3 grid-cols-2">
      <div className="rounded-lg border border-[#D7E7FA] p-3 dark:border-slate-850 bg-white dark:bg-slate-905">
        <h5 className="text-[12px] font-black text-[#0B2E63] dark:text-white">Booking Confirm</h5>
        <p className="text-[10.5px] leading-relaxed text-[#5D7596] dark:text-slate-400 mt-1 truncate">"Your appointment is set for Tuesday..."</p>
      </div>
      <div className="rounded-lg border border-[#D7E7FA] p-3 dark:border-slate-850 bg-white dark:bg-slate-905">
        <h5 className="text-[12px] font-black text-[#0B2E63] dark:text-white">Payment Reminder</h5>
        <p className="text-[10.5px] leading-relaxed text-[#5D7596] dark:text-slate-400 mt-1 truncate">"A friendly reminder that your balance..."</p>
      </div>
    </div>
  </div>
);
...
const SenderTrustMockup: React.FC = () => (
  <div className="grid h-full gap-4 p-4 sm:p-5 sm:grid-cols-2 justify-center items-center">
    <div className="rounded-2xl border border-slate-200 bg-white p-4 dark:border-slate-800 dark:bg-[#0B1627] flex flex-col items-center">
      <span className="text-[10px] font-black text-rose-650 uppercase tracking-wider mb-3">Unbranded SMS Outbox</span>
      <div className="w-[180px] rounded-3xl border-4 border-slate-350 p-2.5 dark:border-slate-700 bg-slate-50 dark:bg-[#07111F]">
        <div className="mb-2 text-center text-[10px] font-black text-slate-450">+63 917 987 6543</div>
        <div className="rounded-2xl bg-white p-2.5 text-[11px] leading-relaxed text-[#425B7D] dark:bg-[#102B4F] dark:text-slate-350 shadow-sm">
    ...
    <div className="rounded-2xl border border-blue-200 bg-white p-4 dark:border-blue-900/35 dark:bg-[#0B1627] flex flex-col items-center shadow-sm shadow-[#1F5AAE]/3">
      ...
      <div className="w-[180px] rounded-3xl border-4 border-[#BCD7F5] p-2.5 dark:border-slate-700 bg-slate-50 dark:bg-[#07111F]">
        <div className="mb-2 text-center text-[10px] font-black text-[#1F5AAE] dark:text-[#72A8FF]">NOLASMSPro</div>
        <div className="rounded-2xl bg-[#E8F3FF] p-2.5 text-[11px] leading-relaxed text-[#0B2E63] dark:bg-[#102B4F] dark:text-[#9AC3FF] shadow-sm">
          Please confirm your checkout with NOLA SMS Pro.
        </div>
      </div>
...
const SenderIdListMockup: React.FC = () => (
  <div className="flex h-full flex-col p-4 sm:p-5">
    <div className="flex justify-between items-center mb-3">
      <span className="text-[10px] font-black text-blue-500 uppercase tracking-wider">Sender ID Registry</span>
    ...
    <div className="space-y-2">
      <div className="flex justify-between items-center rounded-lg border border-slate-100 p-2.5 bg-white dark:border-slate-800 dark:bg-slate-905">
        <span className="text-xs font-black text-[#0B2E63] dark:text-white">NOLASMSPro</span>
        <span className="rounded bg-blue-50 text-blue-650 px-1.5 py-0.5 text-[9px] font-black dark:bg-[#102B4F] dark:text-[#72A8FF]">System Default</span>
      </div>
      <div className="flex justify-between items-center rounded-lg border border-slate-100 p-2.5 bg-white dark:border-slate-800 dark:bg-slate-905 shadow-sm shadow-[#1F5AAE]/3">
        <span className="text-xs font-black text-[#0B2E63] dark:text-white">STORENAME</span>
      ...
      <div className="flex justify-between items-center rounded-lg border border-slate-100 p-2.5 bg-white dark:border-slate-800 dark:bg-slate-905">
        <span className="text-xs font-black text-[#0B2E63] dark:text-white">MYAGENCY</span>
...
const CreditDeductionMockup: React.FC = () => (
  <div className="flex h-full flex-col p-4 sm:p-5 justify-center gap-4">
    <h4 className="text-[13px] font-black text-[#0B2E63] dark:text-white uppercase tracking-wider">Credit Deduction Estimator</h4>
    <div className="grid gap-3 sm:grid-cols-2">
      <div className="rounded-xl border border-[#D7E7FA] bg-white p-3 dark:border-[#1B2E4A] dark:bg-slate-900 shadow-sm">
        <div className="flex justify-between items-center mb-2">
          <span className="text-[10px] font-black text-[#1F5AAE] dark:text-[#72A8FF] uppercase tracking-wider">GSM Standard</span>
          <span className="rounded bg-[#E8F3FF] px-1.5 py-0.5 text-[9px] font-black text-[#1F5AAE] dark:bg-[#102B4F]">1 Credit</span>
        </div>
        <p className="text-xs font-mono text-[#5D7596] leading-relaxed mb-2 dark:text-slate-400">"Your booking #123 is confirmed."</p>
...
const MessageHistoryListMockup: React.FC = () => (
  <div className="flex h-full flex-col p-4 sm:p-5">
    <div className="flex justify-between items-center mb-3">
      <span className="text-[10px] font-black text-blue-500 uppercase tracking-wider">Real-time Outbound History Logs</span>
      <span className="text-[9px] rounded bg-[#E8F3FF] px-1.5 py-0.5 text-[#1F5AAE] dark:bg-[#102B4F] dark:text-[#72A8FF] font-bold">Today</span>
    </div>
    <div className="overflow-x-auto">
      <table className="w-full text-left text-[11px]">
        <thead>
        ...
        <tbody className="divide-y divide-slate-100/50 dark:divide-slate-800/50 text-[#425B7D] dark:text-slate-300">
          ...
          <tr>
            ...
            <td className="py-1.5"><span className="rounded bg-blue-550/10 text-blue-650 px-1.5 py-0.5 text-[9px] font-black dark:bg-[#102B4F] dark:text-[#72A8FF]">Sending 🕒</span></td>
          </tr>
          <tr>
...
export const ScreenshotPlaceholder: React.FC<ScreenshotPlaceholderProps> = ({
  ...
  return (
    <figure
      className="group overflow-hidden rounded-2xl border border-[#BCD7F5] bg-white shadow-sm shadow-[#184B8F]/8 dark:border-[#1F3D68] dark:bg-[#07111F] dark:shadow-none"
      role="img"
    ...
    >
      <div className="flex items-center justify-between gap-3 border-b border-[#D7E7FA] bg-[#F8FBFF] px-4 py-3 dark:border-[#183354] dark:bg-[#0B1627]">
        <div className="flex min-w-0 items-center gap-2">
          ...
          <span className="truncate text-[10px] font-black uppercase tracking-[0.16em] text-[#526A8B] dark:text-slate-400">
            Educational Concept Mockup
          </span>
        </div>
        <div className="flex flex-shrink-0 items-center gap-2">
          <span className="hidden text-[9px] font-black uppercase tracking-[0.16em] text-[#7B93B1] dark:text-slate-500 sm:inline">
            {variant}
          </span>
          {figure !== undefined && (
            <span className="rounded-md bg-[#E8F3FF] px-2 py-1 text-[9px] font-black uppercase tracking-wider text-[#1F5AAE] dark:bg-[#102B4F] dark:text-[#9AC3FF]">
              Fig {figure}
            </span>
          )}
        </div>
      ...
      <div className={`screenshot-frame flex ${heightMap[height]} ${ratioMap[mode]} p-4 sm:p-5`}>
        ...
        <div className="relative mx-auto flex h-full w-full max-w-[1280px] flex-col overflow-hidden rounded-xl border border-white/85 bg-white shadow-lg shadow-[#184B8F]/12 dark:border-[#25476F] dark:bg-[#07111F] dark:shadow-none">
      ...
      <figcaption className="border-t border-[#D7E7FA] px-4 py-3 dark:border-[#183354] bg-[#F8FBFF] dark:bg-[#07111F]/50">
        <p className="text-[13px] font-semibold leading-snug text-[#425B7D] dark:text-slate-300">
          {caption}
        </p>
        {note && (
          <p className="mt-1 text-[11px] text-[#7B93B1] dark:text-slate-500">
            {note}
          </p>
        )}
      </figcaption>
